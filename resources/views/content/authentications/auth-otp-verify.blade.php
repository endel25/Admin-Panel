            ...
            <div class="card p-2">
                ...
                <div class="card-body mt-2">
                    ...
                    <form id="formVerifyOtp" class="mb-3" action="{{ route('password.reset.otp') }}" method="POST">
                        ...
                        <button id="setNewPasswordButton" class="btn btn-primary d-grid w-100" disabled>Set New Password</button>
                    </form>
                </div>
            </div>
            <!-- /Verify OTP -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateForm() {
            ...
            // Check if all fields have values and if the passwords match
            if (otpValue !== '' && passwordValue !== '' && passwordConfirmationValue !== '' && passwordValue === passwordConfirmationValue) {
                setNewPasswordButton.disabled = false; // Enable button
            } else {
                setNewPasswordButton.disabled = true; // Disable button
            }
        }
