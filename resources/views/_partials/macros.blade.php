...
<span style="color:{{ $color }};" >
  {{-- <svg width="30" height="{{ $height }}" viewBox="0 0 250 196" fill="none" xmlns="https://5.imimg.com/data5/SELLER/Logo/2022/9/FH/WP/DQ/108975308/endel-digital-logo0-4-01-02-01-274x300-1.png">
  ...
  <a href="index.html" class="main-logo flex shrink-0 items-center">
    <img class="ml-[5px] flex-none" src="{{ asset('assets/img/endel.png')}}" alt="image" style="width: 40px; height: auto;" />
    <span style="color:#196876; font-size: 1.25rem;" class="align-middle font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">ENDEL DIGITAL</span>
</a>
